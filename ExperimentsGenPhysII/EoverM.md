...
### ● Background — Part I — Magnetic Field Measurement
...
MOVE AROUND A FEW CENTIMETERS IN ALL DIRECTIONS, is it uniform? admonition
...
### ● Background — Part II — e/m Ratio of the Electron
...
- Paragraph of your results ± uncertainties from your data. Make sure to include discussion of the following:
  - PART I
    ...
    - Does the measured B-field (Part 1) in the center of the coils *generally* agree with the expected field strength from {eq}`eq-bfield`? What could cause your experimental value to not agree?
  - PART II
