...
```{figure} ExperimentSimpleProjectileFigures/M3_Exp1.png
...
```{figure} ExperimentSimpleProjectileFigures/M3_ExpOptions_quarter_size.png
...
```{figure} ExperimentSimpleProjectileFigures/M3_Exp3.png
